...
public class ResearchSetup {
    ...
    public static void setup(){
        ...
        register("rank_items", 69420666, "升级项目", 20, BlueSlimeItems.EAGLE_STAR, BlueSlimeItems.AIR_ROD,
                BlueSlimeItems.FIRE_POWDER, BlueSlimeItems.WATER_ORB, BlueSlimeItems.EARTH_FLOWER);
        register("rank_items_2", 69420667, "升级项目高级", 30, BlueSlimeItems.ROC_HEAD, BlueSlimeItems.PHOENIX_WART,
